...
const sizes = {
  sm: { img: "h-11 w-auto", text: "text-[22px]", slogan: "text-[9px]" },
  md: { img: "h-16 w-auto", text: "text-[30px]", slogan: "text-[11px]" },
  lg: { img: "h-20 w-auto", text: "text-[38px]", slogan: "text-[13px]" },
};
...
const BrandLogo = ({ size = "md", className = "", showSlogan = false, variant = "auto" }: BrandLogoProps) => {
  ...
  return (
    <div className={`flex items-center justify-center ${className}`}>
      <img src={logoIcon} alt="SimulaPool" className={`${s.img} shrink-0 -mr-1`} loading="eager" decoding="async" fetchPriority="high" />
