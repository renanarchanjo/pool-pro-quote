      ...
      <div className="min-h-screen flex w-full bg-muted/30">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="h-14 md:h-14 min-h-[3.5rem] flex items-center border-b border-border/50 bg-background px-4 mobile-matriz-header">
            <SidebarTrigger className="min-w-[56px] min-h-[56px] flex items-center justify-center [&>svg]:!w-8 [&>svg]:!h-8 md:min-w-0 md:min-h-0 md:[&>svg]:!w-5 md:[&>svg]:!h-5" />
            <span className="ml-3 text-sm font-medium text-muted-foreground md:hidden">{store?.name || "Painel"}</span>
          </header>
