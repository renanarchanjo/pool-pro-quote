...
const ResetPassword = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-hero p-4">
        <Card className="w-full max-w-md p-8 shadow-xl border-0 bg-white/95 backdrop-blur-md text-center">
          <img src={logoHorizontal} alt="SIMULAPOOL" className="h-20 object-contain mx-auto mb-6" />
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-hero p-4">
        <Card className="w-full max-w-md p-8 shadow-xl border-0 bg-white/95 backdrop-blur-md text-center">
          <img src={logoHorizontal} alt="SIMULAPOOL" className="h-20 object-contain mx-auto mb-4" />
